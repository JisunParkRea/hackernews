# relay gives every object a global unique identifier,
# creates a cursor-based pagination structure
# and introduces the input parameter to mutations
import graphene
...
# new query with LinkNode
class RelayQuery(graphene.ObjectType):
    relay_link = graphene.relay.Node.Field(LinkNode)
    # Connection which implements the pagination structure
